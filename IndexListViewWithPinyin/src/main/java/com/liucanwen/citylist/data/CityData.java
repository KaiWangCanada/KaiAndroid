...
public class CityData
{
    ...
    public static ArrayList<IndexListItem> getSampleContactList()
    {
        ArrayList<IndexListItem> list = new ArrayList<IndexListItem>();
        ...
        try
        {
            ...
            for(int i = 0; i < ja1.length(); i++)
            {
                ...
                list.add(new IndexListItem(cityName, PinYin.getPinYin(cityName)));
            }
        }
